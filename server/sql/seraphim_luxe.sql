...
INSERT INTO `products` (`id`, `label`, `price`, `category_id`, `subcategory_id`, `description`, `image_url`, `variants`, `stock_status`, `stock_quantity`, `stock_threshold`, `reserved_quantity`, `views_count`, `orders_count`, `total_revenue`, `is_featured`, `created_at`, `modified_at`) VALUES
	...
	(11, 'Bella Madre Gold Necklace', 7500.00, 2, 6, 'Luxurious Bella Madre collection gold necklace', 'products/bella_madre_gold_01', '[{"price": 7500, "stock": 10, "images": ["bella_madre_gold_01.webp", "bella_madre_gold_02.webp"], "material": "Gold"}]', 'in_stock', 8, 3, 0, 0, 0, 7575.00, 1, '2025-08-27 20:17:17', '2025-10-12 08:20:11'),
