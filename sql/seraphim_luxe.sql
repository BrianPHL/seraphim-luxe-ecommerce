...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `gender` enum('Male','Female','undisclosed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'undisclosed',
...
CREATE TABLE IF NOT EXISTS `live_chat_messages` (
  ...
  `sender_type` enum('customer','agent','system') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `target_audience` enum('all','customer','admin') COLLATE utf8mb4_general_ci DEFAULT 'all',
  `message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `is_read` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT (now()),
  `modified_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `live_chat_messages_room_id` (`room_id`),
  KEY `live_chat_messages_sender_id` (`sender_id`),
  KEY `live_chat_messages_created_at` (`created_at`),
  CONSTRAINT `live_chat_messages_room_fkey` FOREIGN KEY (`room_id`) REFERENCES `live_chat_rooms` (`id`) ON DELETE CASCADE,
  CONSTRAINT `live_chat_messages_sender_fkey` FOREIGN KEY (`sender_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
	(307, 20, 63, 'system', 'customer', 'You are now connected. An agent will be with you shortly...', 0, '2025-11-06 02:49:27', '2025-11-06 02:49:27'),
	(308, 20, 63, 'customer', 'all', 'hey', 0, '2025-11-06 02:49:32', '2025-11-06 02:49:32'),
	(309, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 02:49:36', '2025-11-06 03:05:55'),
	(310, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 02:49:36', '2025-11-06 03:05:55'),
	(311, 20, 62, 'system', 'customer', 'Agent has concluded the session. Waiting for another agent...', 1, '2025-11-06 02:55:58', '2025-11-06 03:05:55'),
	(312, 20, 62, 'system', 'admin', 'You have concluded the session. Chat returned to waiting queue.', 1, '2025-11-06 02:55:58', '2025-11-06 03:05:55'),
	(313, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 02:56:00', '2025-11-06 03:05:55'),
	(314, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 02:56:00', '2025-11-06 03:05:55'),
	(315, 20, 62, 'system', 'customer', 'Agent has concluded the session. Waiting for another agent...', 1, '2025-11-06 02:56:02', '2025-11-06 03:05:55'),
	(316, 20, 62, 'system', 'admin', 'You have concluded the session. Chat returned to waiting queue.', 1, '2025-11-06 02:56:02', '2025-11-06 03:05:55'),
	(317, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 02:58:44', '2025-11-06 03:05:55'),
	(318, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 02:58:44', '2025-11-06 03:05:55'),
	(319, 20, 62, 'system', 'customer', 'Agent has concluded the session. Waiting for another agent...', 1, '2025-11-06 02:58:47', '2025-11-06 03:05:55'),
	(320, 20, 62, 'system', 'admin', 'You have concluded the session. Chat returned to waiting queue.', 1, '2025-11-06 02:58:47', '2025-11-06 03:05:55'),
	(321, 20, 63, 'system', 'customer', 'You have disconnected from the Live Agent chat.', 0, '2025-11-06 02:58:50', '2025-11-06 02:58:50'),
	(322, 20, 63, 'system', 'admin', 'Customer has disconnected from the Live Agent chat.', 0, '2025-11-06 02:58:50', '2025-11-06 02:58:50'),
	(323, 20, 63, 'system', 'customer', 'Reconnected. An agent will be with you shortly...', 0, '2025-11-06 03:05:55', '2025-11-06 03:05:55'),
	(324, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 03:05:57', '2025-11-06 03:20:24'),
	(325, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 03:05:57', '2025-11-06 03:20:24'),
	(326, 20, 62, 'agent', 'all', 'hey', 1, '2025-11-06 03:05:59', '2025-11-06 03:20:24'),
	(327, 20, 62, 'system', 'customer', 'Agent has concluded the session. Waiting for another agent...', 1, '2025-11-06 03:06:07', '2025-11-06 03:20:24'),
	(328, 20, 62, 'system', 'admin', 'You have concluded the session. Chat returned to waiting queue.', 1, '2025-11-06 03:06:07', '2025-11-06 03:20:24'),
	(329, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 03:06:10', '2025-11-06 03:20:24'),
	(330, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 03:06:10', '2025-11-06 03:20:24'),
	(331, 20, 63, 'system', 'customer', 'You have disconnected from the Live Agent chat.', 0, '2025-11-06 03:08:02', '2025-11-06 03:08:02'),
	(332, 20, 63, 'system', 'admin', 'Customer has disconnected from the Live Agent chat.', 0, '2025-11-06 03:08:02', '2025-11-06 03:08:02'),
	(333, 20, 63, 'system', 'customer', 'Reconnected. An agent will be with you shortly...', 0, '2025-11-06 03:20:24', '2025-11-06 03:20:24'),
	(334, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 03:20:31', '2025-11-06 03:56:18'),
	(335, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 03:20:31', '2025-11-06 03:56:18'),
	(336, 20, 62, 'agent', 'all', 'Hi!', 1, '2025-11-06 03:20:34', '2025-11-06 03:56:18'),
	(337, 20, 63, 'customer', 'all', 'Heyo!', 0, '2025-11-06 03:20:38', '2025-11-06 03:20:38'),
	(338, 20, 63, 'system', 'customer', 'You have disconnected from the Live Agent chat.', 0, '2025-11-06 03:20:49', '2025-11-06 03:20:49'),
	(339, 20, 63, 'system', 'admin', 'Customer has disconnected from the Live Agent chat.', 0, '2025-11-06 03:20:49', '2025-11-06 03:20:49'),
	(340, 20, 63, 'system', 'customer', 'Reconnected. An agent will be with you shortly...', 0, '2025-11-06 03:56:18', '2025-11-06 03:56:18'),
	(341, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 1, '2025-11-06 03:56:19', '2025-11-06 03:59:24'),
	(342, 20, 62, 'system', 'admin', 'You have joined the chat.', 1, '2025-11-06 03:56:19', '2025-11-06 03:59:24'),
	(343, 20, 63, 'customer', 'all', 'Hello', 0, '2025-11-06 03:56:22', '2025-11-06 03:56:22'),
	(344, 20, 63, 'system', 'customer', 'You switched to Seraphim Luxe AI Chatbot.', 0, '2025-11-06 03:56:24', '2025-11-06 03:56:24'),
	(345, 20, 63, 'system', 'admin', 'Customer switched to Seraphim Luxe AI Chatbot.', 0, '2025-11-06 03:56:24', '2025-11-06 03:56:24'),
	(346, 20, 63, 'system', 'customer', 'You have disconnected from the Live Agent chat.', 0, '2025-11-06 03:56:24', '2025-11-06 03:56:24'),
	(347, 20, 63, 'system', 'admin', 'Customer has disconnected from the Live Agent chat.', 0, '2025-11-06 03:56:24', '2025-11-06 03:56:24'),
	(348, 20, 63, 'system', 'customer', 'Reconnected. An agent will be with you shortly...', 0, '2025-11-06 03:59:24', '2025-11-06 03:59:24'),
	(349, 20, 62, 'system', 'customer', 'Agent Brian Lawrence Pasco has joined the chat.', 0, '2025-11-06 03:59:25', '2025-11-06 03:59:25'),
	(350, 20, 62, 'system', 'admin', 'You have joined the chat.', 0, '2025-11-06 03:59:25', '2025-11-06 03:59:25'),
	(351, 20, 63, 'system', 'customer', 'You switched to Seraphim Luxe AI Chatbot.', 0, '2025-11-06 03:59:28', '2025-11-06 03:59:28'),
	(352, 20, 63, 'system', 'admin', 'Customer switched to Seraphim Luxe AI Chatbot.', 0, '2025-11-06 03:59:28', '2025-11-06 03:59:28'),
	(353, 20, 63, 'system', 'customer', 'You have disconnected from the Live Agent chat.', 0, '2025-11-06 03:59:28', '2025-11-06 03:59:28'),
	(354, 20, 63, 'system', 'admin', 'Customer has disconnected from the Live Agent chat.', 0, '2025-11-06 03:59:28', '2025-11-06 03:59:28');
...
CREATE TABLE IF NOT EXISTS `live_chat_rooms` (
  ...
  `status` enum('waiting','active','concluded') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'waiting',
  `priority` enum('low','medium','high') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'low',
  `created_at` timestamp NOT NULL DEFAULT (now()),
  `closed_at` timestamp NULL DEFAULT NULL,
  `modified_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `live_chat_rooms_customer_id` (`customer_id`),
  KEY `live_chat_rooms_agent_id` (`agent_id`),
  KEY `live_chat_rooms_status` (`status`),
  CONSTRAINT `live_chat_rooms_agent_fkey` FOREIGN KEY (`agent_id`) REFERENCES `accounts` (`id`) ON DELETE SET NULL,
  CONSTRAINT `live_chat_rooms_customer_fkey` FOREIGN KEY (`customer_id`) REFERENCES `accounts` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  KEY `notifications_type_index` (`type`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  CONSTRAINT `FK_order_items_seraphim_luxe.products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS `order_refunds` (
  ...
  `refund_method` enum('cash_on_delivery','paypal','bank_transfer','credit_card') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `metal_type` tinyint DEFAULT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `image_url` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `variants` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `stock_status` enum('in_stock','low_stock','out_of_stock') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'out_of_stock',
...
INSERT INTO `products` (`id`, `label`, `price`, `category_id`, `subcategory_id`, `metal_type`, `description`, `image_url`, `variants`, `stock_status`, `stock_quantity`, `stock_threshold`, `reserved_quantity`, `views_count`, `orders_count`, `total_revenue`, `is_featured`, `created_at`, `modified_at`) VALUES
	(1, 'Maxi Pearl Gold Bracelet', 4500.00, 2, 4, 1, 'Elegant maxi pearl bracelet in gold finish', 'products/maxi_pearl_gold_01', '[{"price": 4500, "stock": 10, "images": ["maxi_pearl_gold_01.webp", "maxi_pearl_gold_02.webp", "maxi_pearl_gold_03.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:05:55'),
	(2, 'Rigid Gold Bracelet', 3800.00, 2, 4, 1, 'Classic rigid gold bracelet with modern design', 'products/rigid_gold_01', '[{"price": 3800, "stock": 10, "images": ["rigid_gold_01.webp", "rigid_gold_02.webp", "rigid_gold_03.webp"], "material": "Gold"}]', 'in_stock', 6, 3, 0, 0, 0, 15200.00, 0, '2025-08-27 20:17:17', '2025-11-02 06:30:16'),
	(3, 'Rigid Interlocking Gold Bracelet', 4200.00, 2, 4, 1, 'Sophisticated interlocking design gold bracelet', 'products/rigid_interlocking_gold_01', '[{"price": 4200, "stock": 10, "images": ["rigid_interlocking_gold_01.webp", "rigid_interlocking_gold_02.webp", "rigid_interlocking_gold_03.webp"], "material": "Gold"}]', 'in_stock', 12, 5, 0, 0, 0, 4200.00, 0, '2025-08-27 20:17:17', '2025-11-02 11:21:10'),
	(4, 'Rigid with Relief Gold Bracelet', 4800.00, 2, 4, 1, 'Textured relief design gold bracelet', 'products/rigid_with_relief_gold_01', '[{"price": 4800, "stock": 10, "images": ["rigid_with_relief_gold_01.webp", "rigid_with_relief_gold_02.webp", "rigid_with_relief_gold_03.webp", "rigid_with_relief_gold_04.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:14:32'),
	(5, 'Shiny Intertwined Gold Bracelet', 4000.00, 2, 4, 1, 'Elegant intertwined design with shiny gold finish', 'products/shiny_intertwined_gold_01', '[{"price": 4000, "stock": 10, "images": ["shiny_intertwined_gold_01.webp", "shiny_intertwined_gold_02.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:13:41'),
	(6, 'Beaded Drop Earrings', 2800.00, 2, 5, 1, 'Elegant beaded drop earrings for special occasions', 'products/beaded_drop_mixed_metal_01', '[{"price": 2800, "stock": 10, "images": ["beaded_drop_mixed_metal_01.webp", "beaded_drop_mixed_metal_02.webp"], "material": "Mixed Metal"}]', 'low_stock', 0, 3, 0, 0, 0, 51268.00, 1, '2025-08-27 20:17:17', '2025-11-02 12:24:37'),
	(7, 'Combined Flower Earrings', 3200.00, 2, 5, 2, 'Beautiful flower-inspired earrings with intricate details', 'products/combined_flower_mixed_metal_01', '[{"price": 3200, "stock": 10, "images": ["combined_flower_mixed_metal_01.webp", "combined_flower_mixed_metal_02.webp", "combined_flower_mixed_metal_03.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:12:27'),
	(8, 'Flower Pendant Earrings', 2900.00, 2, 5, 0, 'Delicate flower pendant earrings with graceful movement', 'products/flower_pendant_mixed_metal_01', '[{"price": 2900, "stock": 10, "images": ["flower_pendant_mixed_metal_01.webp", "flower_pendant_mixed_metal_02.webp", "flower_pendant_mixed_metal_03.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:12:10'),
	(9, 'Linked Hoop Earrings with Crystals', 3800.00, 2, 5, 2, 'Stunning linked hoop earrings adorned with crystals', 'products/linked_hoop_earrings_mixed_metal_with_crystals_01', '[{"price": 3800, "stock": 10, "images": ["linked_hoop_earrings_mixed_metal_with_crystals_01.webp", "linked_hoop_earrings_mixed_metal_with_crystals_01.webp", "linked_hoop_earrings_mixed_metal_with_crystals_01.webp"], "material": "Mixed Metal with Crystals"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:13:30'),
	(10, 'Long Beaded Earrings', 3500.00, 2, 5, 2, 'Dramatic long beaded earrings for evening wear', 'products/long_beaded_mixed_metal_01', '[{"price": 3500, "stock": 10, "images": ["long_beaded_mixed_metal_01.webp", "long_beaded_mixed_metal_02.webp", "long_beaded_mixed_metal_03.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:12:43'),
	(11, 'Bella Madre Gold Necklace', 7500.00, 2, 6, 1, 'Luxurious Bella Madre collection gold necklace', 'products/bella_madre_gold_01', '[{"price": 7500, "stock": 10, "images": ["bella_madre_gold_01.webp", "bella_madre_gold_02.webp"], "material": "Gold"}]', 'in_stock', 0, 3, 0, 0, 0, 69825.00, 1, '2025-08-27 20:17:17', '2025-11-02 05:25:47'),
	(12, 'Crystal Pendant Leather Necklace', 4200.00, 2, 6, 2, 'Modern crystal pendant on premium leather cord', 'products/pendant_leather_with_crystal_01', '[{"price": 4200, "stock": 10, "images": ["pendant_leather_with_crystal_01.webp", "pendant_leather_with_crystal_02.webp", "pendant_leather_with_crystal_03.webp"], "material": "Leather w/ Crystal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:14:00'),
	(13, 'Drop Necklace with Sphere Silver', 5800.00, 2, 6, 0, 'Elegant silver drop necklace with sphere pendant', 'products/drop_necklace_with_sphere_silver_01', '[{"price": 5800, "stock": 10, "images": ["drop_necklace_with_sphere_silver_01.webp", "drop_necklace_with_sphere_silver_01.webp", "drop_necklace_with_sphere_silver_01.webp", "drop_necklace_with_sphere_silver_01.webp"], "material": "Silver"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:14:53'),
	(14, 'Flower Pendant Gold Necklace', 6200.00, 2, 6, 1, 'Exquisite flower pendant necklace in gold', 'products/flower_pendant_gold_01', '[{"price": 6200, "stock": 10, "images": ["flower_pendant_gold_01.webp", "flower_pendant_gold_02.webp", "flower_pendant_gold_03.webp", "flower_pendant_gold_04.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:15:09'),
	(15, 'Loved Circle Gold Necklace', 5500.00, 2, 6, 1, 'Romantic circle pendant gold necklace', 'products/loved_circle_gold_01', '[{"price": 5500, "stock": 10, "images": ["loved_circle_gold_01.webp", "loved_circle_gold_02.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:14:44'),
	(16, 'Bancroft Scroll Silver Bracelet', 5200.00, 1, 1, 0, 'Elegant scroll design silver bracelet for men', 'products/bancroft_scroll_silver_bracelet_01', '[{"price": 5200, "stock": 10, "images": ["bancroft_scroll_silver_bracelet_01.webp", "bancroft_scroll_silver_bracelet_02.webp"], "material": "Silver"}]', 'in_stock', 0, 3, 0, 0, 0, 52000.00, 1, '2025-08-27 20:17:17', '2025-11-02 06:02:19'),
	(17, 'Braided Bangle Bracelet', 4800.00, 1, 1, 0, 'Classic braided bangle bracelet with modern appeal', 'products/braided_bangle_mixed_metal_bracelet_01', '[{"price": 4800, "stock": 10, "images": ["braided_bangle_mixed_metal_bracelet_01.webp", "braided_bangle_mixed_metal_bracelet_02.webp"], "material": "Mixed Metal"}]', 'in_stock', 3, 3, 0, 0, 0, 33600.00, 1, '2025-08-27 20:17:17', '2025-11-02 06:29:27'),
	(18, 'Minimal Cuban Bracelet', 3500.00, 1, 1, 0, 'Sleek minimal cuban link bracelet', 'products/minimal_cuban_steel_bracelet_01', '[{"price": 3500, "stock": 25, "images": ["minimal_cuban_steel_bracelet_01.webp", "minimal_cuban_steel_bracelet_02.webp"], "material": "Steel"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:09:09'),
	(19, 'Tiffany Lock Bangle', 7500.00, 1, 1, 1, 'Luxury lock design bangle bracelet', 'products/tiffany_lock_bangle_steel_01', '[{"price": 7500, "stock": 10, "images": ["tiffany_lock_bangle_steel_01.webp", "tiffany_lock_bangle_steel_02.webp"], "material": "Steel"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:11:44'),
	(20, 'Vesper Chain Bracelet Gold', 6200.00, 1, 1, 1, 'Premium vesper chain bracelet in gold finish', 'products/vesper_chain_bracelet_gold_01', '[{"price": 6200, "stock": 10, "images": ["vesper_chain_bracelet_gold_01.webp", "vesper_chain_bracelet_gold_01.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:11:12'),
	(21, 'Celestial Cross Earrings', 2800.00, 1, 2, 0, 'Bold celestial cross design earrings', 'products/celestial_cross_earrings_mixed_metal_01', '[{"price": 2800, "stock": 10, "images": ["celestial_cross_earrings_mixed_metal_01.webp", "celestial_cross_earrings_mixed_metal_02.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:08:58'),
	(22, 'Hammered Silver Stud', 2200.00, 1, 2, 0, 'Textured hammered silver stud earrings', 'products/hammered_silver_stud_01', '[{"price": 2200, "stock": 10, "images": ["hammered_silver_stud_01.webp", "hammered_silver_stud_02.webp"], "material": "Silver"}]', 'in_stock', 9, 3, 0, 0, 0, 2200.00, 0, '2025-08-27 20:17:17', '2025-11-02 05:04:15'),
	(23, 'Nyx Ear Silver Stud', 2500.00, 1, 2, 0, 'Sleek Nyx collection silver stud earrings', 'products/nyx_ear_silver_stud_01', '[{"price": 2500, "stock": 10, "images": ["nyx_ear_silver_stud_01.webp", "nyx_ear_silver_stud_01.webp"], "material": "Silver"}]', 'in_stock', 9, 3, 0, 0, 0, 2500.00, 0, '2025-08-27 20:17:17', '2025-11-02 05:04:40'),
	(24, 'Square Stud Earrings', 2400.00, 1, 2, 0, 'Modern square design stud earrings', 'products/square_stud_earrings_mixed_metal_01', '[{"price": 2400, "stock": 10, "images": ["square_stud_earrings_mixed_metal_01.webp", "square_stud_earrings_mixed_metal_02.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:08:36'),
	(25, 'Tiffany Titan Earrings', 4500.00, 1, 2, 1, 'Premium Tiffany Titan collection earrings', 'products/tiffany_titan_earrings_titanium_01', '[{"price": 4500, "stock": 10, "images": ["tiffany_titan_earrings_titanium_01.webp", "tiffany_titan_earrings_titanium_02.webp"], "material": "Titanium"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:09:49'),
	(26, 'Classic Mens Minimal Box Cuban Chain', 6000.00, 1, 3, 2, 'Premium minimal box cuban chain for men', 'products/classic_mens_minimal_box_cuban_chain_silver_01', '[{"price": 6000, "stock": 10, "images": ["classic_mens_minimal_box_cuban_chain_silver_01.webp", "classic_mens_minimal_box_cuban_chain_silver_02.webp", "classic_mens_minimal_box_cuban_chain_silver_03.webp"], "material": "Silver"}, {"price": 9000, "stock": 10, "images": ["classic_mens_minimal_box_cuban_chain_gold_01.webp", "classic_mens_minimal_box_cuban_chain_gold_02.webp", "classic_mens_minimal_box_cuban_chain_gold_03.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:11:04'),
	(27, 'Minimal Pendant Necklace', 4200.00, 1, 3, 0, 'Sleek minimal pendant necklace for everyday wear', 'products/minimal_pendant_necklace_mixed_metal_01', '[{"price": 4200, "stock": 25, "images": ["minimal_pendant_necklace_mixed_metal_01.webp", "minimal_pendant_necklace_mixed_metal_02.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:09:23'),
	(28, 'Monieyta Rectangular Spiral Bar Pendant', 5800.00, 1, 3, 0, 'Unique rectangular spiral bar pendant design', 'products/monieyta_rectangular_spiral_bar_pendant_steel_01', '[{"price": 5800, "stock": 15, "images": ["monieyta_rectangular_spiral_bar_pendant_steel_01.webp", "monieyta_rectangular_spiral_bar_pendant_steel_02.webp"], "material": "Steel"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:10:56'),
	(29, 'N917 Curb Necklace', 5200.00, 1, 3, 0, 'Classic N917 curb chain necklace', 'products/n917_curb_necklace_mixed_metal_01', '[{"price": 5200, "stock": 18, "images": ["n917_curb_necklace_mixed_metal_01.webp", "n917_curb_necklace_mixed_metal_02.webp", "n917_curb_necklace_mixed_metal_03.webp"], "material": "Mixed Metal"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:10:32'),
	(30, 'Sleek Apex Titanium Steel Bar Pendant', 6500.00, 1, 3, 2, 'Modern titanium steel bar pendant with sleek design', 'products/sleek_apex_titanium_steel_bar_pendant_01', '[{"price": 6500, "stock": 12, "images": ["sleek_apex_titanium_steel_bar_pendant_01.webp", "sleek_apex_titanium_steel_bar_pendant_02.webp"], "material": "Titanium Steel"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:11:30'),
	(31, 'David Yurman Box Chain Bracelet', 8500.00, 3, 7, 0, 'Luxury David Yurman box chain bracelet for all genders', 'products/david_yurman_box_chain_bracelet_silver_01', '[{"price": 8500, "stock": 6, "images": ["david_yurman_box_chain_bracelet_silver_01.webp", "david_yurman_box_chain_bracelet_silver_02.webp"], "material": "Silver"}, {"price": 8800, "stock": 6, "images": ["david_yurman_box_chain_bracelet_black_01.webp", "david_yurman_box_chain_bracelet_black_02.webp"], "material": "Black"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:23:24'),
	(32, 'Gucci Interlocking G Silver Bracelet', 9200.00, 3, 7, 0, 'Iconic Gucci interlocking G silver bracelet', 'products/gucci_interlocking_g_silver_bracelet_silver_01', '[{"price": 9200, "stock": 10, "images": ["gucci_interlocking_g_silver_bracelet_silver_01.webp", "gucci_interlocking_g_silver_bracelet_silver_02.webp", "gucci_interlocking_g_silver_bracelet_silver_03.webp"], "material": "Silver"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:23:43'),
	(33, 'Montblanc MeisterstÃ¼ck Collection Steel 3 Rings Bracelet', 7800.00, 3, 7, 2, 'Premium Montblanc MeisterstÃ¼ck steel and leather bracelet', 'products/montblanc_meisterstuck_collection_steel_3_rings_bracelet_white_leather_01', '[{"price": 7800, "stock": 8, "images": ["montblanc_meisterstuck_collection_steel_3_rings_bracelet_white_leather_01.webp"], "material": "Steel with White Leather"}, {"price": 7900, "stock": 8, "images": ["montblanc_meisterstuck_collection_steel_3_rings_bracelet_red_leather_02.webp"], "material": "Steel with Red Leather"}, {"price": 7850, "stock": 8, "images": ["montblanc_meisterstuck_collection_steel_3_rings_bracelet_brown_leather_03.webp"], "material": "Steel with Brown Leather"}, {"price": 7950, "stock": 8, "images": ["montblanc_meisterstuck_collection_steel_3_rings_bracelet_light_blue_leather_04.webp"], "material": "Steel with Light Blue Leather"}]', 'in_stock', 3, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-26 13:48:43'),
	(34, 'Tateossian Pop Rigato Double Wrap Leather Bracelet', 4500.00, 3, 7, 2, 'Contemporary double wrap leather bracelet by Tateossian', 'products/tateossian_pop_rigato_double_wrap_leather_bracelet_leather_01', '[{"price": 4400, "stock": 5, "images": ["tateossian_pop_rigato_double_wrap_leather_bracelet_black_leather_02.webp"], "material": "Black Leather"}, {"price": 4450, "stock": 5, "images": ["tateossian_pop_rigato_double_wrap_leather_bracelet_brown_leather_03.webp"], "material": "Brown Leather"}, {"price": 4500, "stock": 5, "images": ["tateossian_pop_rigato_double_wrap_leather_bracelet_blue_leather_04.webp", "tateossian_pop_rigato_double_wrap_leather_bracelet_blue_leather_05.webp"], "material": "Blue Leather"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:21:08'),
	(35, 'Tom Wood Curb M Bracelet', 5200.00, 3, 7, 0, 'Scandinavian design Tom Wood curb bracelet', 'products/tom_wood_curb_m_bracelet_silver_01', '[{"price": 5200, "stock": 9, "images": ["tom_wood_curb_m_bracelet_silver_01.webp", "tom_wood_curb_m_bracelet_silver_02.webp"], "material": "Silver"}, {"price": 5800, "stock": 9, "images": ["tom_wood_curb_m_bracelet_gold_03.webp", "tom_wood_curb_m_bracelet_gold_04.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:21:30'),
	(36, 'AMYO Tiny Stud Earring', 1800.00, 3, 8, 2, 'Minimalist tiny stud earrings by AMYO', 'products/amyo_tiny_stud_earring_04', '[{"price": 1800, "stock": 10, "images": ["amyo_tiny_stud_earring_gold_01.webp"], "material": "Gold"}, {"price": 1600, "stock": 10, "images": ["amyo_tiny_stud_earring_copper_02.webp"], "material": "Copper"}, {"price": 1700, "stock": 10, "images": ["amyo_tiny_stud_earring_silver_03.webp"], "material": "Silver"}]', 'in_stock', 9, 3, 0, 0, 0, 1800.00, 0, '2025-08-27 20:17:17', '2025-11-02 05:05:25'),
	(37, 'GLAMIRA Black Stud Earring', 2200.00, 3, 8, 2, 'Elegant stud earrings by GLAMIRA in multiple finishes', 'products/glamira_black_stud_earring_01', '[{"price": 2200, "stock": 8, "images": ["glamira_black_stud_earring_silver_02.webp"], "material": "Silver"}, {"price": 2400, "stock": 9, "images": ["glamira_black_stud_earring_gold_03.webp"], "material": "Gold"}, {"price": 2350, "stock": 8, "images": ["glamira_black_stud_earring_rosegold_04.webp"], "material": "Rose Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:19:21'),
	(38, 'JAXXON Silver Cross Stud Earring', 2800.00, 3, 8, 0, 'Bold silver cross stud earrings by JAXXON', 'products/jaxxon_silver_cross_stud_earring_silver_01', '[{"price": 2800, "stock": 10, "images": ["jaxxon_silver_cross_stud_earring_silver_01.webp", "jaxxon_silver_cross_stud_earring_silver_02.webp", "jaxxon_silver_cross_stud_earring_silver_03.webp", "jaxxon_silver_cross_stud_earring_silver_04.webp"], "material": "Silver"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:19:53'),
	(39, 'MEJURI Gold Huggie Hoop Earrings', 3200.00, 3, 8, 1, 'Classic gold huggie hoop earrings by MEJURI', 'products/mejuri_gold_huggie_hoop_earrings_gold_01', '[{"price": 3200, "stock": 10, "images": ["mejuri_gold_huggie_hoop_earrings_gold_01.webp", "mejuri_gold_huggie_hoop_earrings_gold_02.webp", "mejuri_gold_huggie_hoop_earrings_gold_03.webp", "mejuri_gold_huggie_hoop_earrings_gold_04.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:20:29'),
	(40, 'REGALROSE Small Plain Silver Hoop Earring', 2400.00, 3, 8, 0, 'Simple and elegant small silver hoop earrings', 'products/regalrose_small_plain_silver_hoop_earring_silver_01', '[{"price": 2400, "stock": 10, "images": ["regalrose_small_plain_silver_hoop_earring_silver_01.webp", "regalrose_small_plain_silver_hoop_earring_silver_02.webp", "regalrose_small_plain_silver_hoop_earring_silver_03.webp"], "material": "Silver"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:19:32'),
	(41, 'Caitlyn Minimalist Interlocking Circles Necklace', 4800.00, 3, 9, 2, 'Modern minimalist interlocking circles necklace', 'products/caitlyn_minimalist_interlocking_circles_necklace_mixed_metal_01', '[{"price": 4800, "stock": 8, "images": ["caitlyn_minimalist_interlocking_circles_necklace_mixed_metal_01.webp", "caitlyn_minimalist_interlocking_circles_necklace_mixed_metal_02.webp", "caitlyn_minimalist_interlocking_circles_necklace_mixed_metal_03.webp", "caitlyn_minimalist_interlocking_circles_necklace_mixed_metal_04.webp"], "material": "Mixed Metal"}]', 'in_stock', 5, 3, 0, 0, 0, 24000.00, 1, '2025-08-27 20:17:17', '2025-11-02 06:28:32'),
	(42, 'GIVA Anushka Sharma Silver Deer Heart Necklace', 3200.00, 3, 9, 0, 'Elegant deer heart necklace by GIVA featuring Anushka Sharma collection', 'products/giva_anushka_sharma_silver_deer_heart_necklace_silver_01', '[{"price": 3200, "stock": 10, "images": ["giva_anushka_sharma_silver_deer_heart_necklace_silver_01.webp", "giva_anushka_sharma_silver_deer_heart_necklace_silver_02.webp", "giva_anushka_sharma_silver_deer_heart_necklace_silver_03.webp", "giva_anushka_sharma_silver_deer_heart_necklace_silver_04.webp"], "material": "Silver"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:20:58'),
	(43, 'GLAMIRA Minimalist Necklace', 2800.00, 3, 9, 1, 'Sleek minimalist necklace design by GLAMIRA', 'products/glamira_minimalist_necklaces_gold_01', '[{"price": 2800, "stock": 10, "images": ["glamira_minimalist_necklaces_gold_01.webp", "glamira_minimalist_necklaces_gold_02.webp", "glamira_minimalist_necklaces_gold_03.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:20:22'),
	(44, 'Minimalist Lab Roman Numerals Diamond Band Necklace', 5500.00, 3, 9, 2, 'Sophisticated roman numerals diamond band necklace', 'products/minimalist_lab_roman_numerals_diamond_band_necklace_gold_01', '[{"price": 5500, "stock": 8, "images": ["minimalist_lab_roman_numerals_diamond_band_necklace_gold_01.webp", "minimalist_lab_roman_numerals_diamond_band_necklace_gold_04.webp"], "material": "Gold with Diamonds"}, {"price": 5400, "stock": 4, "images": ["minimalist_lab_roman_numerals_diamond_band_necklace_rosegold_02.webp"], "material": "Rose Gold with Diamonds"}, {"price": 5200, "stock": 3, "images": ["minimalist_lab_roman_numerals_diamond_band_necklace_silver_03"], "material": "Silver with Diamonds"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:21:49'),
	(45, 'Tiffany T Smile Necklace', 8500.00, 3, 9, 1, 'Iconic Tiffany T Smile collection necklace', 'products/tiffany_t_smile_necklace_gold_01', '[{"price": 8500, "stock": 10, "images": ["tiffany_t_smile_necklace_gold_01.webp", "tiffany_t_smile_necklace_gold_02.webp", "tiffany_t_smile_necklace_gold_03.webp", "tiffany_t_smile_necklace_gold_04.webp"], "material": "Gold"}]', 'in_stock', 10, 3, 0, 0, 0, 0.00, 0, '2025-08-27 20:17:17', '2025-10-12 13:23:34');
...
CREATE TABLE IF NOT EXISTS `products_promotions` (
  ...
  KEY `FK_products_promotions_seraphim_luxe.products` (`product_id`),
  CONSTRAINT `FK_products_promotions_seraphim_luxe.products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `product_images` (
  ...
  CONSTRAINT `FK_product_images_seraphim_luxe.products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `product_reviews` (
  ...
  KEY `product_id` (`product_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `product_reviews_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products_old` (`id`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `stocks_history` (
  ...
  CONSTRAINT `FK_stocks_history_seraphim_luxe.products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE RESTRICT,
